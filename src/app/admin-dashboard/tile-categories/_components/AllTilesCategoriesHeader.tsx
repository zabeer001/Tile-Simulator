...
const AllTilesCategoriesHeader = () => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between pb-[20px]">
        ...
        <div>
          <Link href="/admin-dashboard/add-edit-categories"><button className="flex items-center gap-2 text-white bg-primary py-4 px-8 text-base font-medium leading-[120%] rounded-[8px]">
            {" "}
