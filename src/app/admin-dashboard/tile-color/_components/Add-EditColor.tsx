...
function AddEditColor({ color, onCancel, onSave }: AddEditColorProps) {
  ...
  const [selectedColor, setSelectedColor] = useState(color?.Color || "#FFF")
  ...
  const handleSave = () => {
    ...
    const newColor: AllTilesColorDataType = {
      ...
      Name: title,
      image: selectedImage || "/assets/tile1.png",
      Date: new Date().toLocaleDateString("en-US", { day: "2-digit", month: "short", year: "numeric" }),
      Color: selectedColor || "#FFFFFF", // Include the Color field
    }
      ...
      <div className="bg-white rounded-lg p-6 shadow-md">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <Label className="text-base font-medium mb-2 block">Select Color:</Label>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {isEditing && color?.Color && (
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        />
                        <span className="text-xs text-gray-500">Previous: {color.Color}</span>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div>
              <Label className="text-base font-medium mb-2 block">Select Image:</Label>
              <div className="relative">
                <div
                ...
                <div className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-[calc(50%+8px)] text-3xl font-bold text-gray-700">
                  OR
                </div>
              </div>
            </div>
